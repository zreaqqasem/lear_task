...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.gmail.yujisobe.native_dialog.NativeDialogPlugin());
    } catch(Exception e) {
      Log.e(TAG, "Error registering plugin native_dialog, com.gmail.yujisobe.native_dialog.NativeDialogPlugin", e);
    }
    try {
